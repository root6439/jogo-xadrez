...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if(!type.equals("B") && !type.equals("C") && !type.equals("Q") && !type.equals("T")) {
			throw new InvalidParameterException("Peca para promocao nao existe");
		}
	...
	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("A peca nao pode se mover para o destino escolhido");
		}
	}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException(
				"Nao existe o rei " + color + " no tabuleiro, nao era pra isso acontecer nao meu companheiro");
	}
